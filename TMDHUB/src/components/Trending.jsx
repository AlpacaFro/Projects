...
const Trending = () => {
  ...
  return (
    <>
      <div className="w-screen  p-5 mt-16">
        <div className="relative">
          <button
            className=" hidden md:block absolute left-0 top-6 transform -translate-y-1/2 bg-black text-white rounded p-2 z-10"
            onClick={scrollPrev}
          >
            &#8592;
          </button>
          ...
          <div
            ...
            {trendingMovies.length > 0 ? ( //if there's movies then..
              ...
              >
                  ...
                  />
                  <div
                    className={`relative bg-black rounded-b-lg w-52 p-3 drop-shadow-2xl text-white`}
                  >
          ...
          <button
            className="hidden md:block absolute right-0 top-6 transform -translate-y-1/2 bg-black text-white rounded p-2 z-10"
            onClick={scrollNext}
          >
            &#8594;
          </button>
